...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP = "Create a list with any number of items. Type of all items must be the same. Type is defined by the first item in the list. If first item is blank, type is scalar.";  // untranslated
...
Blockly.Msg.LISTS_SET_INDEX_INPUT_TO = "to";  // untranslated
...
Blockly.Msg.PROCEDURES_DEFNORETURN_COMMENT = "User-defined procedure";  // untranslated

...
global_scalar_variables[8] = 'speaker_attached'; // R8
global_scalar_variables[9] = 'mic_attached'; // R9
global_scalar_variables[10] = 'radio_attached'; // R10

var gsv_next = 11; // gsv_next points to the next empty register index

...
Blockly.Python['flash_leds'] = function(block) {
  ...
  if (value_color == 'None') {
    ...
    var code = 'systemFlash(value_color_rgb)\n';
  }
    ...
    var code = 'systemFlash(' + colornum + ',' + arrayRGB + ')\n';
    }
  }
  else {// anything else - maybe it's a variable?
    var code = 'systemFlash(' + value_color + ')\n';
  }
  return code;
};

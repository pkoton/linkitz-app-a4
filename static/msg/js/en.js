...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "If a value is true or not=zero, then do some statements.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "If a value is true or not=zero, then do the first block of statements. Otherwise, do the second block of statements.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "If the first value is true or not=zero, then do the first block of statements. Otherwise, if the second value is true or not=zero, do the second block of statements.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "If the first value is true or not=zero, then do the first block of statements. Otherwise, if the second value is true or not=zero, do the second block of statements. If none of the values are true or not=zero, do the last block of statements.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "While a value is false or zero, then do some statements.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "While a value is true or not=zero, then do some statements.";
...
Blockly.Msg.MATH_SINGLE_OP_ABSOLUTE = "magnitude";
